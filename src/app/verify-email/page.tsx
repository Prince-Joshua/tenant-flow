  ...
  return (
    <Flex minH="100vh" align="center" justify="center" bg="bg.canvas" px="4">
      <Box bg="bg.surface" border="1px solid" borderColor="border.subtle" borderRadius="2xl" p="10" w="full" maxW="420px" textAlign="center">
        ...
        <Text fontSize="xl" fontWeight="bold" color="text.primary" mb="2">{ok ? 'Email verified' : 'Verification failed'}</Text>
        <Text fontSize="sm" color="text.muted" mb="6">{ok ? 'Your email has been verified. You can now sign in.' : 'This link is invalid or has expired.'}</Text>
