  ...
  return (
    <form action={formAction}>
      <Stack gap="6">
        ...
        <Text as="div" fontSize="xs" color="text.muted" textAlign="center">
          By creating an account, you agree to our{" "}
          <ChakraLink href="/terms" color="violet.400">
            Terms of Service
          </ChakraLink>
          .
        </Text>
        <Text as="div" fontSize="sm" color="text.muted" textAlign="center">
          ...
          <ChakraLink href="/login" color="violet.400" fontWeight="medium">
            Sign in
          </ChakraLink>
        </Text>
      </Stack>
